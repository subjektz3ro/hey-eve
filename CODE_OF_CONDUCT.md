...
the repository's [security-advisory form](https://github.com/subjektz3ro/hey-eve/security/advisories/new),
with "Code of Conduct" at the start of the report. All complaints will be
reviewed and investigated promptly and fairly. Reports will be kept
confidential except where disclosure is needed to investigate or address the
incident.
